...
export default function Home() {
  ...
  return (
    <div className="page-fade-in flex min-h-[calc(100vh-8rem)] flex-col gap-8 lg:gap-10">
      {/* Hero */}
      <section className="relative overflow-hidden rounded-3xl border border-[#25282C] bg-[#0A0B0D]">
        {/* Background glow */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -left-20 top-1/2 h-[500px] w-[500px] -translate-y-1/2 rounded-full bg-[#00E5FF]/10 blur-[120px]" />
        ...
        <div className="relative flex flex-col items-center px-6 py-16 text-center lg:py-24">
          <div className="relative mb-8">
            ...
            <img
              ...
              alt="一个世界"
              className="relative h-32 w-32 rounded-3xl object-cover shadow-2xl shadow-[#00E5FF]/20 ring-2 ring-[#FFD700]/30 lg:h-40 lg:w-40"
            />
            <span className="absolute -right-2 -top-2 flex h-8 w-8 items-center justify-center rounded-full bg-[#FFD700] text-[#0A0B0D]">
              <Sparkles className="h-4 w-4" />
            </span>
          </div>

          <h1 className="bg-gradient-to-r from-[#FFD700] via-[#FFE55C] to-[#00E5FF] bg-clip-text text-4xl font-black tracking-tight text-transparent sm:text-5xl lg:text-6xl">
            一个世界
          </h1>
          <p className="mt-2 text-lg font-medium text-[#00E5FF] sm:text-xl">
            One World
          </p>
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:justify-center">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 rounded-2xl border border-[#25282C] bg-[#111215] px-8 py-3.5 text-base font-semibold text-white transition-all hover:border-[#00E5FF]/50 hover:bg-[#1A1D21] hover:shadow-[0_0_24px_rgba(0,229,255,0.12)] active:scale-[0.98]"
            >
      ...
      <section>
        <div className="mb-6 flex items-center gap-3">
          <div>
            <h2 className="text-base font-semibold text-white">世界特色</h2>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          {highlights.map((item) => (
            ...
            >
              ...
              <h3 className="mb-1.5 text-base font-semibold text-white group-hover:text-[#00E5FF]">
                {item.title}
              </h3>
      ...
      {/* CTA */}
      <section className="mt-auto rounded-2xl border border-[#25282C] bg-[#111215]/80 p-6 lg:p-8">
        <div className="flex flex-col items-center justify-between gap-4 text-center lg:flex-row lg:text-left">
          <div>
            <h3 className="text-lg font-bold text-white">准备好打造你的世界了吗？</h3>
