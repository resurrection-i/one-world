    ...
    return (
      <div className="page-fade-in mx-auto max-w-3xl px-4 py-10">
        <div className={cn(sectionCard, sectionCardGlow, "relative text-center")}>
          ...
          <h2 className="text-2xl font-bold text-[#0F172A]">一个世界 Mint 发射成功</h2>
          ...
          <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-center">
            <button className="world-btn-primary" onClick={() => navigate("/mint-launches")}>
              查看 Mint 已发射
            </button>
        ...
        <div className="space-y-5">
          <div className={cn(sectionCard, sectionCardGlow, "sticky top-4")}>
            <div className="text-center">
              ...
              <h3 className="mt-4 text-xl font-bold text-[#0F172A]">{form.tokenName || "一个世界 Mint Token"}</h3>
